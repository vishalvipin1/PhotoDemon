...
#If False Then
    ...
    Private Const SELECT_RECT = 4, SELECT_CIRC = 5, SELECT_POLYGON = 6, SELECT_LASSO = 7, SELECT_WAND = 8
    Private Const TEXT_BASIC = 9, TEXT_ADVANCED = 10
    Private Const PAINT_PENCIL = 11, PAINT_SOFTBRUSH = 12, PAINT_ERASER = 13, PAINT_CLONE = 14, PAINT_FILL = 15, PAINT_GRADIENT = 16
#End If
